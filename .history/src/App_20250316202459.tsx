      ...
      <div className="flex flex-row gap-8 w-full max-w-[1400px]">
          ...
          <div className="flex gap-4 mb-6">
            <div className="w-1/2">
              ...
              <select
                ...
                className="w-full mt-1 pl-3 pr-4 py-3 border rounded-lg text-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
              >
        ...
        <div className="w-1/2 p-6 bg-white rounded-xl">
          ...
          <ResponsiveContainer width="100%" height={400}>
            <RadarChart outerRadius={150} data={exchangeRates}>
              <PolarGrid />
              <PolarAngleAxis dataKey="currency" />
              <PolarRadiusAxis />
              <Tooltip />
              <Radar name="Exchange Rate" dataKey="rate" stroke="#2563eb" fill="#2563eb" fillOpacity={0.6} />
            </RadarChart>
          </ResponsiveContainer>
        </div>
      </div>
