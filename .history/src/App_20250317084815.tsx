...
import { useExchangeRates, useSupportedCurrencies } from "./Store/useExchangeRates"; // Import new hook
...
function CurrencyConverter() {
  ...
  const { data: currencies, isLoading } = useSupportedCurrencies(); // Fetch all currencies dynamically
