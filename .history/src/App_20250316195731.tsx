...
function App() {
  ...
  <div className="relative">
    <input
      ...
      className="w-full mt-1 pl-12 pr-4 py-3 border-3 border-gray-300 rounded-lg text-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
  ...
  <div className="w-1/2">
    ...
    <div className="relative">
      <select
        ...
        className="w-full mt-1 pl-10 pr-4 py-3 border-3 border-gray-300 rounded-lg text-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
      >
