...
function CurrencyConverter() {
  ...
  <h2 className="flex justify-center text-xl sm:text-2xl md:text-4xl lg:text-5xl text-gray-800 font-semibold font-serif gap-2 items-center mb-4 sm:mb-5 md:mb-6 lg:mb-8 text-center">
  ...
  <div className="w-full mb-4 sm:mb-5 md:mb-6">
    ...
    <div className="relative">
      <input
        ...
        className="border border-gray-300 rounded-xl shadow-sm w-full text-sm sm:text-base md:text-lg focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all pl-10 pr-4 py-2 sm:py-3 md:pl-12 mt-1"
  ...
  <div className="flex flex-col md:flex-row gap-4 mb-4 md:mb-6">
    ...
    <div className="w-full md:w-1/2">
      ...
      <div className="relative">
        <img src={getFlagUrl(fromCurrency)} alt={fromCurrency} className="border border-gray-300 h-5 w-5 sm:h-6 sm:w-6 rounded-full absolute left-3" />
        <select
          value={fromCurrency}
          onChange={(e) => dispatch(setFromCurrency(e.target.value))}
          className="bg-white border border-gray-300 rounded-xl shadow-sm w-full text-sm sm:text-base md:text-lg appearance-none focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all pl-10 pr-8 sm:pr-10 md:pl-12 md:py-3 py-2 mt-1"
        >
    ...
    <div className="w-full md:w-1/2">
      ...
      <div className="relative">
        <img src={getFlagUrl(toCurrency)} alt={toCurrency} className="border border-gray-300 h-5 w-5 sm:h-6 sm:w-6 rounded-full absolute left-3" />
        <select
          value={toCurrency}
  ...
  <button
    ...
    className="flex justify-center items-center gap-2 bg-blue-600 text-white text-sm sm:text-base md:text-lg font-semibold rounded-lg py-2 sm:py-3 w-full transition duration-300 hover:bg-blue-700"
  >
