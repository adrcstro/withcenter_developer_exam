...
function CurrencyConverter() {
  ...
  <button
    ...
    className="mt-2 flex bg-blue-600 justify-center rounded-lg text-sm text-white w-full duration-300 font-semibold gap-2 hover:bg-blue-700 items-center md:text-lg mt-2 py-2 sm:py-3 sm:text-base transition"
  >
