...
import { ChevronDownIcon } from "@heroicons/react/solid"; // Import Heroicons
  ...
  <div className="w-1/2">
    ...
    <div className="relative flex items-center">
      ...
      <select
        ...
        className="w-full mt-1 pl-10 pr-10 py-3 border rounded-lg text-lg focus:outline-none focus:ring-2 focus:ring-blue-400 appearance-none bg-white"
      >
        {isLoading ? (
