...
function CurrencyConverter() {
  ...
  const conversionRates = { EUR: 0.85, GBP: 0.75, JPY: 110 };
      ...
      <div className="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6 w-full max-w-sm">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white transition-all"
